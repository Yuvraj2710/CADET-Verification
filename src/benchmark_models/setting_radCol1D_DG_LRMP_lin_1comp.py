# -*- coding: utf-8 -*-
"""
Study 2: Radial LRMP, 1 component, Linear kinetic.

Model: RADIAL_COLUMN_MODEL_1D (LRMP — film diffusion, no pore diffusion)
Domain: r in [0.01, 0.26]
VELOCITY_COEFF = 4.5e-3, COL_DISPERSION = 1e-5, COL_POROSITY = 0.6
...
def get_model():
    ...
    # Particle: LRMP with film diffusion, no pore diffusion
