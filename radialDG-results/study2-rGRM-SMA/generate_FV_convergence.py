#!/usr/bin/env python3
"""Compute FV WENO3 self-convergence for rGRM SMA 4comp.

Uses Z2048 as finest reference. Produces CSV and plots.
"""
...
def main():
    ...
    for z in LEVELS:
        ...
        # Linf error: max absolute error over time points, max across components
    ...
    # Print table
    print(f"\nFV WENO3 self-convergence for rGRM SMA 4comp (ref = Z{REF})")
    ...
    csv_path = os.path.join(OUT_DIR, 'rGRM_SMA_FV.csv')
