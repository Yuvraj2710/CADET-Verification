#!/usr/bin/env python3
"""rGRM lin 1comp -- FV vs DG convergence (v6: v5 dispersion + original pore diffusion).

COL_DISPERSION = 5.75e-11, FILM_DIFFUSION = 6.9e-8, PAR_DIFFUSION = 6.07e-10 (original)
Reference: FV Z1024.
"""
...
BASE = os.path.expanduser("~/CADET-Verification/output/test_cadet-core/radialDG/v6-lin")
