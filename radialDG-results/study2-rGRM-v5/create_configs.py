#!/usr/bin/env python3
"""Create h5 input files for rGRM v5 study — intermediate dispersion.

Between v3 (too smooth) and v4 (too sharp):
  COL_DISPERSION:  5.75e-8  -> 5.75e-11  (1000x less)
  PAR_DIFFUSION:   6.07e-10 -> 6.07e-12  (100x less)
  FILM_DIFFUSION:  6.9e-6   -> 6.9e-8    (100x less)
...
MID_DISPERSION = {
    'col_dispersion': [5.75e-11],   # 1000x less (was 5.75e-8)
    'film_diffusion': [6.9e-8],     # 100x less (was 6.9e-6)
    'pore_diffusion': [6.07e-12],   # 100x less (was 6.07e-10)
}
