#!/usr/bin/env python3
"""Create h5 input files for rGRM v5 study — SMA 4comp, intermediate dispersion.

Same reduction factors as lin 1comp v5:
  COL_DISPERSION:  5.75e-8  -> 5.75e-11  (1000x less, per component)
  FILM_DIFFUSION:  6.9e-6   -> 6.9e-8    (100x less, per component)
  PORE_DIFFUSION:  [7e-10, 6.07e-11, 6.07e-11, 6.07e-11]
                -> [7e-12, 6.07e-13, 6.07e-13, 6.07e-13]  (100x less)
...
OUTPUT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                          '..', '..', 'output', 'test_cadet-core', 'radialDG', 'v5-SMA')
...
MID_DISPERSION = {
    'col_dispersion': [5.75e-11] * NCOMP,
    'film_diffusion': [6.9e-8] * NCOMP,
    'pore_diffusion': [7e-12, 6.07e-13, 6.07e-13, 6.07e-13],
}
...
def main():
    ...
    print("=== GRM SMA 4comp -- INTERMEDIATE DISPERSION (v5) ===")
    print(f"  COL_DISPERSION = {MID_DISPERSION['col_dispersion'][0]:.2e}")
    print(f"  FILM_DIFFUSION = {MID_DISPERSION['film_diffusion'][0]:.2e}")
    print(f"  PORE_DIFFUSION = {MID_DISPERSION['pore_diffusion']}")
    print()
