#!/usr/bin/env python3
"""rGRM lin 1comp -- FV vs DG convergence (intermediate dispersion v5).

COL_DISPERSION = 5.75e-11, FILM_DIFFUSION = 6.9e-8, PAR_DIFFUSION = 6.07e-12
Reference: FV Z1024.
"""
...
BASE = os.path.join(os.path.dirname(__file__), '..', '..', '..', 'output', 'test_cadet-core', 'radialDG', 'v5-results')
...
def main():
    ...
    make_plot(fv_dofs, fv_linf, dg_dof,
              ...
              f'rGRM lin (intermediate dispersion) -- Outlet (ref FV Z{FV_REF})',
